...
public class LoggingAspect {
	...
	@Before("com.in28minutes.learnspringaop.aopexample.aspects.CommonPointcutConfig.businessPackageConfig()")//WHEN
	public void logMethodCallBeforeExecution(JoinPoint joinPoint) {
		//Logic What to Do
		logger.info("Before Aspect - {} is called with arguments: {}"
				,  joinPoint.getSignature(), joinPoint.getArgs()); //WHAT
		//joinPoint.getSignature will give us method signature
	}
